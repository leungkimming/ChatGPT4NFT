...
public sealed class TimePlugin {
	...
	[KernelFunction]
	[Description("Get the date ahead by a provided number of days from today")]
	public string DaysAhead([Description("The number of days ahead of today")] double input, IFormatProvider? formatProvider = null) =>
	...
	[KernelFunction]
	[Description("Get the date of the next day matching the supplied week day name in English.")]
	public string DateMatchingNextDayName(
